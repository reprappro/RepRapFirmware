...
G31 Z0.4 P540                       ; Set the probe height and threshold (deliberately too high to avoid bed crashes on initial setup)
...
M305 P0                     ; set bed thermistor resistance at 25C
