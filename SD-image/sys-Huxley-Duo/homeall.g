...
G1 X40 F2000      ; move X, ADJUST the X value to get Z probe over the bed
...
G92 Y0            ; set position to Y=0
G1 Y5 F2000       ; move Y, ADJUST the Y value to get Z probe over the bed
